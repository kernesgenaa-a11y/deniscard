...
class Es implements En {
  ...
  Map<String, String> dictionary = {
    ...
    // Removed: Spanish localization stub (project now uses only English and Ukrainian)

    // This file was preserved as a stub to avoid build errors; Spanish localization
    // has been removed from active locale list. See lib/services/localization/locale.dart
    // for currently enabled locales.
